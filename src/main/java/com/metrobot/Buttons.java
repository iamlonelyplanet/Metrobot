...
public class Buttons {
    ...
    public static final LinkedHashMap<String, Point> ARENA_BUTTONS = new LinkedHashMap<>() {{
        ...
        put("Закрыть - поражение", new Point(480, 463)); // копия Закрыть 2, чтобы в режиме Friends окна не сворачивались

        put("Нежданчик - снять", new Point(115, 495));
        put("Нежданчик - закрыть", new Point(560, 495));

        put("Похвастаться - снять", new Point(197, 520));
        put("Похвастаться - закрыть", new Point(460, 520));

        put("Друг", new Point(85, 565));
        put("Атаковать друга", new Point(85, 495));
        put("Стрелка вправо", new Point(660, 565));
    }};
    ...
    public static final LinkedHashMap<String, Point> CLAN_BUTTONS = new LinkedHashMap<>() {{
        ...
        put("Граната красная", new Point(420, 465));
