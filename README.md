...
В версии 1.2.1 доступны следующие режимы:
- бои на Арене;
- бои в Клановых войнах;
- участие в Рейдах;
- набивание туннельных монстров (Ящеров и Пауков) в Туннелях;
- экспериментальный режим ежедневных заданий у Начстанции: Крысы. 30 боёв с этими монстрами.
...
![img_3.png](https://github.com/iamlonelyplanet/Metrobot/raw/master/src/main/resources/Help/img_3.png)
...
![img_1.png](https://github.com/iamlonelyplanet/Metrobot/blob/master/src/main/resources/Help/img_1.png?raw=true).
...
![([[animation-kv.gif](https://github.com/iamlonelyplanet/Metrobot/raw/master/src/main/resources/Help/animation-kv.gif))]](https://github.com/iamlonelyplanet/Metrobot/raw/master/src/main/resources/Help/animation-kv.gif)
...
![blackstripe.gif](https://github.com/iamlonelyplanet/Metrobot/blob/master/src/main/resources/Help/blackstripe.gif?raw=true)
...
![(img_5.png)](https://github.com/iamlonelyplanet/Metrobot/blob/master/src/main/resources/Help/img_5.png?raw=true) 

![img_6.png](https://github.com/iamlonelyplanet/Metrobot/blob/master/src/main/resources/Help/img_6.png?raw=true).

![img_7.png](https://github.com/iamlonelyplanet/Metrobot/blob/master/src/main/resources/Help/img_7.png?raw=true).
...
![img_9.png](https://github.com/iamlonelyplanet/Metrobot/blob/master/src/main/resources/Help/img_9.png?raw=true)
...
![img_8.png](https://github.com/iamlonelyplanet/Metrobot/blob/master/src/main/resources/Help/img_8.png?raw=true)
...
3. Арена.
   ...
   ![[img_4.png]](https://github.com/iamlonelyplanet/Metrobot/blob/master/src/main/resources/Help/img_4.png?raw=true)

Допускается одновременная работа первых трёх режимов (желательно не больше двух). Для этого нужно запускать start.bat 
столько, сколько вам нужно. Пример: запустили первый экземпляр программы в режиме КВ. Для работы в Рейде опять дважды
кликаем по Start.exe, задаём режим "Рейд", устанавливаем время старта. Нужно, чтобы активность двух экземпляров не 
пересекалась. Чтобы боты не мешали друг другу кликать. Хорошая практика - подгадать время старта рейда спустя 1-3 мин
после очередной серии кликов в КВ.
...
В этом режиме удобно прокачивать питомцев, однако МетроБот не умеет закрывать уведомление о достижении питомцем 
следующего уровня, кликая после этого вхолостую до конца 45-минутной работы.
...
счётчики обнуляются автоматически. Трогать нежелательно.
...
Большое спасибо Егору, автору замечательного Java-курса "Дорогу осилит идущий": 
...
А также всем тестерам, которые помогали при разработке МетроБота, особенно Инне.
